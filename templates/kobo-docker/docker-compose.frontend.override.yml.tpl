...
services:
  kobocat:
    ...
    ${USE_DNS}extra_hosts:
      ...
      ${EXPOSE_BACKEND_PORTS}- postgres.${PRIVATE_DOMAIN_NAME}:${MASTER_BACKEND_IP}
      ${EXPOSE_BACKEND_PORTS}- mongo.${PRIVATE_DOMAIN_NAME}:${MASTER_BACKEND_IP}
      ${EXPOSE_BACKEND_PORTS}- redis-main.${PRIVATE_DOMAIN_NAME}:${MASTER_BACKEND_IP}
      ${EXPOSE_BACKEND_PORTS}- redis-cache.${PRIVATE_DOMAIN_NAME}:${MASTER_BACKEND_IP}
...
${USE_BACKEND_NETWORK}      name: ${PREFIX}_kobo-be-network
